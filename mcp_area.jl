...
coordinates) and y (northing coordinates) columns. The x and y coordinates 
must be in a coordinate reference system in meters (e.g., UTM's) for the
output to be in square meters.
